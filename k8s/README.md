# Kubernetes Manifests - FIAP Notifications API

Manifestos Kubernetes para deploy da Notifications API no cluster.
...
# 3. Verificar
kubectl get all -n fiap-cloud-games -l app=notifications-api
```
