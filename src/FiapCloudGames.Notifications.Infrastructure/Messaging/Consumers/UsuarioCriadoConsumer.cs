...
{
    public class UsuarioCriadoConsumer : BackgroundService
    {
        private readonly IServiceProvider _serviceProvider;
        private readonly ConnectionFactory _factory;

        public UsuarioCriadoConsumer(IServiceProvider serviceProvider, IConfiguration configuration)
        {
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            consumer.ReceivedAsync += async (_, ea) =>
            {
                ...
                var evento = JsonSerializer.Deserialize<UsuarioCriadoEvent>(json);
                ...
                var handler = scope.ServiceProvider.GetRequiredService<UsuarioCriadoNotificacaoService>();
